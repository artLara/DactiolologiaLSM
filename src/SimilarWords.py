class SimilarWords:
    def __init__(self, pathOfObjectDirectory='', porcessAllSteps=False):
        self.vocabulary = set()
        self.prob = {}
        self.prob_join = {}
        self.N = 0 # Total of sentences
        # self.tp = TextPreprocessing(pathOfObjectDirectory) #instance of TextPreprocessing Class
        if porcessAllSteps:
            try:
                self.initializeProbs(pathOfObjectDirectory, processAllTexts=True, maxTexts=2300)
